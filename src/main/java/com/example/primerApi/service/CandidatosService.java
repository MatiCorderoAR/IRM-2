...
public class CandidatosService {
    ...
    @Autowired
    public CandidatosService(IRMRepository IRMRepository) {this.IRMRepository = IRMRepository;
    }
    /* ----------------------------- FIND ----------------------------- */
    ...
    public Optional<Candidatos> findMovieByNombre(String nombre) {
         IRMRepository.findBy(nombre);
